...
par(mfrow=c(2,2))
# insert plot2
plot(data_plot2$Global_active_power~as.POSIXct(data_plot2$DateTime), type = "l", ylab = "Global Active Power", xlab = "")
# insert plot of voltage and datetime
with(data_plot2, plot(Voltage~as.POSIXct(data_plot2$DateTime),type = "l",ylab = "Voltage", xlab = "datetime"))
# insert plot3
...
# insert plot of Golbal_reactive_power and datetime
with(data_plot2, plot(Global_reactive_power~as.POSIXct(data_plot2$DateTime),type = "l", xlab = "datetime"))
dev.off()
